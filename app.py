...
MONSTER_TYPES = {
    ...
    "crab": {
        ...
        "energy_cost": 15,
        "rewards": {"gold": [25, 50], "xp": [45, 75], "resources": {"fish": [20, 50]}, "gear_drop_chance": 0.25},
    },
    "bat": {
        "tier": 1, "min_level": 1, "combat_power": 25,
        "variants": ["Ice Bat", "Cave Bat", "Frost Wing"],
        "energy_cost": 15,
        "rewards": {"gold": [20, 45], "xp": [36, 66], "resources": {"herbs": [20, 40]}, "gear_drop_chance": 0.25},
    },
    "rat": {
        "tier": 1, "min_level": 1, "combat_power": 5,
        "variants": ["Frost Rat", "Sewer Rat", "Snow Mouse"],
        "energy_cost": 15,
        "rewards": {"gold": [12, 38], "xp": [30, 60], "resources": {"bones": [10, 30]}, "gear_drop_chance": 0.20},
    },
    "shell_lurker": {
        "tier": 1, "min_level": 1, "combat_power": 12,
        "variants": ["Tide Shell", "Giant Conch", "Lurking Shell"],
        "energy_cost": 15,
        "rewards": {"gold": [20, 45], "xp": [36, 66], "resources": {"fish": [10, 40]}, "gear_drop_chance": 0.20},
    },
    "ice_squid": {
        "tier": 1, "min_level": 1, "combat_power": 18,
        "variants": ["Baby Squid", "Frost Squid", "Ink Specter"],
        "energy_cost": 15,
        "rewards": {"gold": [25, 45], "xp": [36, 66], "resources": {"fish": [20, 40], "herbs": [10, 20]}, "gear_drop_chance": 0.20},
    },
    "frost_beetle": {
        "tier": 1, "min_level": 1, "combat_power": 8,
        "variants": ["Tunnel Bug", "Ice Crawler", "Crystal Grub"],
        "energy_cost": 15,
        "rewards": {"gold": [15, 35], "xp": [30, 60], "resources": {"bones": [10, 20]}, "gear_drop_chance": 0.20},
    },
    "pufferfish": {
        "tier": 1, "min_level": 1, "combat_power": 22,
        "variants": ["Toxic Puffer", "Spiky Fish", "Blowfish"],
        "energy_cost": 15,
        "rewards": {"gold": [20, 40], "xp": [36, 66], "resources": {"fish": [20, 50], "herbs": [10, 20]}, "gear_drop_chance": 0.25},
    },
    ...
    "wolf": {
        ...
        "energy_cost": 15,
        "rewards": {"gold": [50, 100], "xp": [90, 150], "resources": {"bones": [30, 60], "blood_gems": [10, 20]}, "gear_drop_chance": 0.20},
    },
    "snowman": {
        "tier": 2, "min_level": 5, "combat_power": 82,
        "variants": ["Cursed Snowman", "Frost Golem", "Ice Construct"],
        "energy_cost": 15,
        "rewards": {"gold": [55, 105], "xp": [96, 156], "resources": {"spell_fragments": [20, 40]}, "gear_drop_chance": 0.18},
    },
    "shadow_penguin": {
        "tier": 2, "min_level": 5, "combat_power": 72,
        "variants": ["Shadow Penguin", "Dark Penguin", "Void Waddle"],
        "energy_cost": 15,
        "rewards": {"gold": [55, 95], "xp": [84, 144], "resources": {"blood_gems": [20, 40]}, "gear_drop_chance": 0.22},
    },
    "ice_hawk": {
        "tier": 2, "min_level": 5, "combat_power": 32,
        "variants": ["Storm Hawk", "Tundra Raptor", "Frozen Eagle"],
        "energy_cost": 15,
        "rewards": {"gold": [45, 90], "xp": [84, 135], "resources": {"herbs": [30, 60]}, "gear_drop_chance": 0.20},
    },
    "frost_scorpion": {
        "tier": 2, "min_level": 5, "combat_power": 62,
        "variants": ["Ice Stinger", "Polar Pincer", "Frost Venom"],
        "energy_cost": 15,
        "rewards": {"gold": [50, 95], "xp": [90, 144], "resources": {"blood_gems": [10, 30], "bones": [20, 40]}, "gear_drop_chance": 0.18},
    },
    "snow_bear": {
        "tier": 2, "min_level": 5, "combat_power": 92,
        "variants": ["Snowfield Cub", "Frost Grizzly", "Avalanche Bear"],
        "energy_cost": 15,
        "rewards": {"gold": [62, 112], "xp": [105, 165], "resources": {"bones": [40, 80]}, "gear_drop_chance": 0.18},
    },
    "frost_wraith": {
        "tier": 2, "min_level": 5, "combat_power": 52,
        "variants": ["Ice Spirit", "Chilling Specter", "Pale Phantom"],
        "energy_cost": 15,
        "rewards": {"gold": [55, 100], "xp": [90, 150], "resources": {"spell_fragments": [10, 30]}, "gear_drop_chance": 0.22},
    },
    ...
    "ice_spider": {
        ...
        "energy_cost": 15,
        "rewards": {"gold": [88, 150], "xp": [120, 195], "resources": {"herbs": [40, 80], "bones": [30, 50]}, "gear_drop_chance": 0.15},
    },
    "frost_shark": {
        "tier": 3, "min_level": 10, "combat_power": 146,
        "variants": ["Glacier Fin", "Deep Frostbite", "Ice Jaw"],
        "energy_cost": 15,
        "rewards": {"gold": [95, 155], "xp": [126, 204], "resources": {"fish": [60, 120]}, "gear_drop_chance": 0.15},
    },
    "tundra_boar": {
        "tier": 3, "min_level": 10, "combat_power": 126,
        "variants": ["Frozen Tusker", "Blizzard Hog", "Snow Crusher"],
        "energy_cost": 15,
        "rewards": {"gold": [82, 145], "xp": [114, 186], "resources": {"bones": [50, 90]}, "gear_drop_chance": 0.15},
    },
    "living_iceblock": {
        "tier": 3, "min_level": 10, "combat_power": 160,
        "variants": ["Frostcube", "Crystalline Mass", "Cryo Entity"],
        "energy_cost": 15,
        "rewards": {"gold": [100, 162], "xp": [135, 210], "resources": {"spell_fragments": [30, 50]}, "gear_drop_chance": 0.14},
    },
    "cursed_owl": {
        "tier": 3, "min_level": 10, "combat_power": 140,
        "variants": ["Night Eye", "Shadow Talon", "Hexed Feather"],
        "energy_cost": 15,
        "rewards": {"gold": [88, 150], "xp": [126, 195], "resources": {"spell_fragments": [20, 50], "herbs": [30, 60]}, "gear_drop_chance": 0.16},
    },
    "glacier_croc": {
        "tier": 3, "min_level": 10, "combat_power": 153,
        "variants": ["Tundra Jaws", "Frost Maw", "Ice Scale"],
        "energy_cost": 15,
        "rewards": {"gold": [95, 158], "xp": [129, 201], "resources": {"fish": [50, 100], "bones": [30, 60]}, "gear_drop_chance": 0.14},
    },
    "night_stalker": {
        "tier": 3, "min_level": 10, "combat_power": 167,
        "variants": ["Shadow Creeper", "Dusk Hunter", "Void Walker"],
        "energy_cost": 15,
        "rewards": {"gold": [100, 162], "xp": [135, 210], "resources": {"blood_gems": [30, 60]}, "gear_drop_chance": 0.15},
    },
    ...
    "golem": {
        ...
        "energy_cost": 15,
        "rewards": {"gold": [138, 212], "xp": [180, 270], "resources": {"bones": [60, 120], "blood_gems": [30, 60]}, "gear_drop_chance": 0.12},
    },
    "serpent": {
        "tier": 4, "min_level": 15, "combat_power": 203,
        "variants": ["Sea Serpent", "Ice Wyrm", "Frost Leviathan"],
        "energy_cost": 15,
        "rewards": {"gold": [145, 225], "xp": [186, 285], "resources": {"fish": [80, 150], "spell_fragments": [30, 50]}, "gear_drop_chance": 0.12},
    },
    "druid": {
        "tier": 4, "min_level": 15, "combat_power": 168,
        "variants": ["Dark Druid", "Cursed Shaman", "Shadow Priest"],
        "energy_cost": 15,
        "rewards": {"gold": [138, 212], "xp": [186, 276], "resources": {"spell_fragments": [50, 90], "herbs": [50, 90]}, "gear_drop_chance": 0.14},
    },
    "ice_drake": {
        "tier": 4, "min_level": 15, "combat_power": 215,
        "variants": ["Frost Whelp", "Arctic Drake", "Glacial Serpent"],
        "energy_cost": 15,
        "rewards": {"gold": [150, 238], "xp": [195, 300], "resources": {"blood_gems": [40, 80], "spell_fragments": [20, 40]}, "gear_drop_chance": 0.12},
    },
    "fallen_knight": {
        "tier": 4, "min_level": 15, "combat_power": 192,
        "variants": ["Lost Paladin", "Cursed Champion", "Hollow Warden"],
        "energy_cost": 15,
        "rewards": {"gold": [145, 230], "xp": [186, 285], "resources": {"bones": [50, 100], "blood_gems": [20, 50]}, "gear_drop_chance": 0.12},
    },
    "blizzard_elemental": {
        "tier": 4, "min_level": 15, "combat_power": 227,
        "variants": ["Storm Core", "Blizzard Wraith", "Polar Force"],
        "energy_cost": 15,
        "rewards": {"gold": [155, 245], "xp": [195, 300], "resources": {"spell_fragments": [40, 80]}, "gear_drop_chance": 0.12},
    },
    ...
    "elite_frostbear": {
        ...
        "energy_cost": 15,
        "rewards": {"gold": [225, 350], "xp": [270, 420], "resources": {"blood_gems": [60, 120], "bones": [80, 150]}, "gear_drop_chance": 0.10},
    },
    "frost_demon": {
        "tier": 5, "min_level": 25, "combat_power": 269,
        "variants": ["Frost Wraith Lord", "Infernal Ice", "Arctic Demon"],
        "energy_cost": 15,
        "rewards": {"gold": [250, 375], "xp": [300, 450], "resources": {"blood_gems": [80, 140], "spell_fragments": [50, 100]}, "gear_drop_chance": 0.10},
    },
    "ancient_wyrm": {
        "tier": 5, "min_level": 25, "combat_power": 273,
        "variants": ["Void Dragon", "Ancient Serpent", "Deep Abyss"],
        "energy_cost": 15,
        "rewards": {"gold": [275, 400], "xp": [330, 495], "resources": {"spell_fragments": [80, 150], "blood_gems": [50, 100]}, "gear_drop_chance": 0.08},
    },
    "deaths_herald": {
        "tier": 5, "min_level": 25, "combat_power": 278,
        "variants": ["Death Knight", "The Reaper", "End Bringer"],
        "energy_cost": 15,
        "rewards": {"gold": [300, 450], "xp": [360, 540], "resources": {"blood_gems": [100, 180], "bones": [100, 180]}, "gear_drop_chance": 0.08},
    },
}
...
def home():
    ...
    # ── Weekly mini-game leaderboard reward -- one-shot login toast ─────────
    # Same "DB row as the delivery marker" idea as the build-leaderboard and
    # raid blocks above: resolve_weekly_minigame_leaderboard() (a scheduled
    # job, not this request) already granted the N00Tbox and wrote the win
    # onto weekly_minigame_winners; that row's own `notified` column is the
    # "already shown" marker. ORDER BY id DESC LIMIT 1 means a player who
    # wins two games the same week only gets toasted for the most recent
    # win -- same tradeoff the other blocks above already accept.
    minigame_reward = None
    if FEATURES.get("minigame_leaderboard", False):
        mgw_row = db.execute(
            "SELECT id, building_id, lootbox_id FROM weekly_minigame_winners "
            "WHERE username=? AND notified=0 ORDER BY id DESC LIMIT 1",
            (username,)
        ).fetchone()
        if mgw_row:
            minigame_reward = {
                "building_id": mgw_row["building_id"],
                "label":       MINIGAME_LABELS.get(mgw_row["building_id"], mgw_row["building_id"]),
                "lootbox_id":  mgw_row["lootbox_id"],
            }
            db.execute("UPDATE weekly_minigame_winners SET notified=1 WHERE id=?", (mgw_row["id"],))
...
# and the other in JS (Award Hall UI); update both together if a label changes.
MINIGAME_LABELS = {
...
def _compute_weekly_minigame_leaderboards_by_game(week_start, week_end):
    ...
    Returns {building_id: [(username, best_score), ...]} sorted best-first,
    one entry per MINIGAME_BUILDING_IDS (empty list if nobody played it).
    """
    db = get_db()
    rows = db.execute(
    ...
    by_game = {building_id: [] for building_id in MINIGAME_BUILDING_IDS}
    for r in rows:
        if r["building_id"] in by_game:
            by_game[r["building_id"]].append((r["username"], r["best"]))
    for building_id in by_game:
        by_game[building_id].sort(key=lambda kv: kv[1], reverse=True)
    return by_game
...
def minigame_leaderboard_route():
    ...
    by_game = _compute_weekly_minigame_leaderboards_by_game(week_start, week_end)

    db = get_db()
    games = {}
    for building_id, ranked in by_game.items():
        entries = []
        for i, (uname, best) in enumerate(ranked[:20], start=1):
...
def resolve_weekly_minigame_leaderboard():
    ...
    week is simply skipped. Mirrors resolve_raid()'s reward pattern but
    winner-take-one per game instead of a shared podium."""
    if not FEATURES.get("minigame_leaderboard", False):
        return
    try:
        now = int(time.time())
        ...
        winners = []
        for building_id in MINIGAME_BUILDING_IDS:
            ranked = by_game.get(building_id) or []
            if not ranked:
                continue
            username, best = ranked[0]
            db.commit()   # release the write lock -- grant_lootbox() opens its own connection
            lootbox_id = grant_lootbox(username, 1, f"minigame_weekly_{building_id}")[0]
            db.execute(
                "INSERT INTO weekly_minigame_winners (week_start, building_id, username, lootbox_id, notified) "
                "VALUES (?,?,?,?,0)",
                (week_start, building_id, username, lootbox_id)
            )
            db.commit()   # same reason as above -- keep the lock free between iterations
            winners.append((building_id, username))

        if winners:
            summary = ", ".join(f"{MINIGAME_LABELS.get(bid, bid)}: {uname}" for bid, uname in winners)
            post_chat_message(
                db, MAYOR_USERNAME,
                f"🎮 Weekly Mini-Game Champions -- {summary}! N00Tboxes awarded!",
                now
            )
            db.commit()
        db.close()
        print(f"[MinigameWeekly] Resolved week {week_start}-{week_end}: winners={winners}")
    except Exception as e:
