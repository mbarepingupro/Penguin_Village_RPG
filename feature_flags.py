FEATURES = {
    ...
    "era_advance": True,    # Gates POST /mayor/advance_era itself -- off means the route
                            ...
                            # this only blocks the one route from actually running. On since
                            # the Mayor is ready to actually advance eras; flip back to False
                            # to disable era advancement again with zero rebuilding.
